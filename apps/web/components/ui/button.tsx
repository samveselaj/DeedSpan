...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-focus transition-colors duration-200 ease-soft disabled:opacity-50 disabled:pointer-events-none select-none",
  {
    variants: {
      variant: {
